...
Reussites.e: ${LIB}/libmachine_trace.a Alea.o Tas.o AfficherTas.o QLL.o C4.o QLL.o InteractionToutes.o Reussites.c
	gcc  -g -I${INCL} -o Reussites.e Reussites.c ${LIB}/graphlib_w.o InteractionToutes.o QLL.o C4.o QLL.o Tas.o AfficherTas.o Alea.o -L${LIB} -lmachine_trace -L/usr/X11R6/lib -lX11 -lm
